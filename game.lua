...
-- Mod Jokers
        ...
        c_roulette=         {order = 33,    discovered = false, cost = 3, consumeable = true, name = "A Roulette", pos = {x=0,y=1}, set = "Tarot", effect = "Roulette", cost_mult = 1.0, invert = 'c_wheel_of_fortune', config = {extra = 4}},                      --Needs checked
        c_weakness=         {order = 34,    discovered = false, cost = 3, consumeable = true, name = "Weakness", pos = {x=1,y=1}, set = "Tarot", effect = "Rank Change", cost_mult = 1.0, invert = 'c_strength', config = {mod_conv = 'shift rank', extra=-1, max_highlighted = 3}}, --Broken
