...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        j_astronomer=       {order = 143,  unlocked = false, discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Astronomer", pos = {x=2,y=7}, set = "Joker", effect = "Price Change", config = {}, unlock_condition = {type = 'discover_amount', planet_count = 12}},
...
-- Mod Jokers
        ...
        --Tarots
        c_fool=             {order = 1,     discovered = false, cost = 3, consumeable = true, name = "The Fool", pos = {x=0,y=0}, set = "Tarot", effect = "Disable Blind Effect", cost_mult = 1.0, invert = 'c_jester', config = {}},
        c_magician=         {order = 2,     discovered = false, cost = 3, consumeable = true, name = "The Magician", pos = {x=1,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_scientist', config = {mod_conv = 'm_lucky', max_highlighted = 2}},
        c_high_priestess=   {order = 3,     discovered = false, cost = 3, consumeable = true, name = "The High Priestess", pos = {x=2,y=0}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, invert = 'c_critic', config = {planets = 2}},
        c_empress=          {order = 4,     discovered = false, cost = 3, consumeable = true, name = "The Empress", pos = {x=3,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_vanity', config = {mod_conv = 'm_mult', max_highlighted = 2}},
        c_emperor=          {order = 5,     discovered = false, cost = 3, consumeable = true, name = "The Emperor", pos = {x=4,y=0}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, invert = 'c_merchant', config = {tarots = 2}},
        c_heirophant=       {order = 6,     discovered = false, cost = 3, consumeable = true, name = "The Hierophant", pos = {x=5,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_non_believer', config = {mod_conv = 'm_bonus', max_highlighted = 2}},
        c_lovers=           {order = 7,     discovered = false, cost = 3, consumeable = true, name = "The Lovers", pos = {x=6,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_cheater', config = {mod_conv = 'm_wild', max_highlighted = 1}},
        c_chariot=          {order = 8,     discovered = false, cost = 3, consumeable = true, name = "The Chariot", pos = {x=7,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_athlete', config = {mod_conv = 'm_steel', max_highlighted = 1}},
        c_justice=          {order = 9,     discovered = false, cost = 3, consumeable = true, name = "Justice", pos = {x=8,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_tyrant', config = {mod_conv = 'm_glass', max_highlighted = 1}},
        c_hermit=           {order = 10,    discovered = false, cost = 3, consumeable = true, name = "The Hermit", pos = {x=9,y=0}, set = "Tarot", effect = "Dollar Doubler", cost_mult = 1.0, invert = 'c_tennent', config = {extra = 20}},
        c_wheel_of_fortune= {order = 11,    discovered = false, cost = 3, consumeable = true, name = "The Wheel of Fortune", pos = {x=0,y=1}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, invert = 'c_roulette', config = {extra = 4}},
        c_strength=         {order = 12,    discovered = false, cost = 3, consumeable = true, name = "Strength", pos = {x=1,y=1}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, invert = 'c_weakness', config = {mod_conv = 'shift rank', extra=1, max_highlighted = 2}}, --Broken
        c_hanged_man=       {order = 13,    discovered = false, cost = 3, consumeable = true, name = "The Hanged Man", pos = {x=2,y=1}, set = "Tarot", effect = "Card Removal", invert = 'c_mercy', cost_mult = 1.0, config = {remove_card = true, max_highlighted = 2}},
        c_death=            {order = 14,    discovered = false, cost = 3, consumeable = true, name = "Death", pos = {x=3,y=1}, set = "Tarot", effect = "Card Conversion", invert = 'c_life', cost_mult = 1.0, config = {mod_conv = 'card', max_highlighted = 2, min_highlighted = 2}},
        ...
        --inverted Tarots Mod
        c_jester=           {order = 23,    discovered = false, cost = 3, consumeable = true, name = "A Jester", pos = {x=0,y=11}, set = "Tarot", effect = "Flip Tarot", cost_mult = 1.0, invert = 'c_fool', config = {}},
        c_scientist=        {order = 24,    discovered = false, cost = 3, consumeable = true, name = "A Scientist", pos = {x=1,y=11}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_magician', config = {mod_conv = 'm_catalyst', max_highlighted = 2}},   --works
        c_critic=           {order = 25,    discovered = false, cost = 3, consumeable = true, name = "A Critic", pos = {x=2,y=11}, set = "Tarot", effect = "Pack Reroll", cost_mult = 1.0, invert = 'c_high_priestess', config = {}},                                -- Some bugs
        c_vanity=           {order = 26,    discovered = false, cost = 3, consumeable = true, name = "Vanity", pos = {x=3,y=11}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_empress', config = {mod_conv = 'm_mirror', max_highlighted = 1}},   --works
        c_merchant=         {order = 27,    discovered = false, cost = 3, consumeable = true, name = "A Merchant", pos = {x=4,y=11}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, invert = 'c_emperor', config = {spectrals = 1}},
        c_non_believer=     {order = 28,    discovered = false, cost = 3, consumeable = true, name = "A Non-Believer", pos = {x=5,y=11}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_heirophant', config = {mod_conv = 'm_blank', max_highlighted = 2}}, --works
        c_cheater=          {order = 29,    discovered = false, cost = 3, consumeable = true, name = "A Cheater", pos = {x=6,y=11}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_lovers', config = {mod_conv = 'm_air', max_highlighted = 1}}, --works
        c_athlete=          {order = 30,    discovered = false, cost = 3, consumeable = true, name = "An Athlete", pos = {x=7,y=11}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_chariot', config = {mod_conv = 'm_muscle', max_highlighted = 2}}, --works
        c_tyrant=           {order = 31,    discovered = false, cost = 3, consumeable = true, name = "A Tyrant", pos = {x=8,y=11}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_justice', config = {mod_conv = 'm_brutal', max_highlighted = 1}}, --works
        c_tennent=          {order = 32,    discovered = false, cost = 3, consumeable = true, name = "A Tennent", pos = {x=9,y=11}, set = "Tarot", effect = "Set money", cost_mult = 1.0, invert = 'c_hermit', config = {extra = 20}},                               --works
        c_roulette=         {order = 33,    discovered = false, cost = 3, consumeable = true, name = "A Roulette", pos = {x=0,y=10}, set = "Tarot", effect = "Roulette", cost_mult = 1.0, invert = 'c_wheel_of_fortune', config = {extra = 4}},                      --works
        c_weakness=         {order = 34,    discovered = false, cost = 3, consumeable = true, name = "Weakness", pos = {x=1,y=10}, set = "Tarot", effect = "Rank Change", cost_mult = 1.0, invert = 'c_strength', config = {mod_conv = 'shift rank', extra=-1, max_highlighted = 3}}, --works
        c_mercy=            {order = 35,    discovered = false, cost = 3, consumeable = true, name = "A Mercy", pos = {x=2,y=10}, set = "Tarot", effect = "Card Creation", cost_mult = 1.0, invert = 'c_hanged_man', config = {extra = 2}},                          --works
        c_life=             {order = 36,    discovered = false, cost = 3, consumeable = true, name = "Life", pos = {x=3,y=10}, set = "Tarot", effect = "Card Conversion", cost_mult = 1.0, invert = 'c_death', config = {mod_conv = 'card', max_highlighted = 2, min_highlighted = 2}}, --works
        c_impulse=          {order = 37,    discovered = false, cost = 3, consumeable = true, name = "An Impulse", pos = {x=4,y=10}, set = "Tarot", effect = "Hand Payout", cost_mult = 1.0, invert = 'c_temperance', config = {extra = 2}},                         --works
        c_angel=            {order = 38,    discovered = false, cost = 3, consumeable = true, name = "An Angel", pos = {x=5,y=10}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_devil', config = {mod_conv = 'm_flame', max_highlighted = 1}}, --works
        c_mountain=         {order = 39,    discovered = false, cost = 3, consumeable = true, name = "A Mountain", pos = {x=6,y=10}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_tower', config = {mod_conv = 'm_crystal', max_highlighted = 1}}, --works
        c_dust=             {order = 40,    discovered = false, cost = 3, consumeable = true, name = "Dust", pos = {x=7,y=10}, set = "Tarot", effect = "Perma Bonus", cost_mult = 1.0, invert = 'c_star', config = {mod_conv = true, extra=10, max_highlighted = 3}}, --works
        c_night=            {order = 41,    discovered = false, cost = 3, consumeable = true, name = "Night", pos = {x=8,y=10}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, invert = 'c_moon', config = {suit_conv = {'Spades','Clubs'}, max_highlighted = 5}}, --works
        c_day=              {order = 42,    discovered = false, cost = 3, consumeable = true, name = "Day", pos = {x=9,y=10}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, invert = 'c_sun', config = {suit_conv = {'Hearts', 'Diamonds'}, max_highlighted = 5}}, --works
        c_verdict=          {order = 43,    discovered = false, cost = 3, consumeable = true, name = "Verdict", pos = {x=0,y=9}, set = "Tarot", effect = "Joker to tags", cost_mult = 1.0, invert = 'c_judgement', config = {}},                                   --works
        c_void=             {order = 44,    discovered = false, cost = 3, consumeable = true, name = "Void", pos = {x=1,y=9}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_world', config = {mod_conv = true, max_highlighted = 3}}, --works
        ...
        b_god=              {name = "God Deck",         stake = 1, unlocked = true,order = 17, pos =   {x=5,y=2}, set = "Back", config = {two_suits = true, randomize_rank_suit = true, normalize_chips = true, boss_reward = 'tag_negative', boss_reward_sound = 'negative'}, discovered = true},
        ...
        --modded enhancements
        m_crystal = {max = 500, order = 10, name = "Crystal Card", set = "Enhanced", pos = {x=4,y=5}, effect = "Crystal Card", label = "Crystal Card", config = {blank_front = true}}, --works
        m_air =     {max = 500, order = 11, name = "Air Card", set = "Enhanced", pos = {x=1,y=5}, effect = "Air Card", label = "Air Card", config = {}},  --works
        m_muscle =  {max = 500, order = 12, name = "Muscle Card", set = "Enhanced", pos = {x=2,y=5}, effect = "Muscle Card", label = "Muscle Card", config = {mult=20}}, --Works
        m_flame =   {max = 500, order = 13, name = "Flame Card", set = "Enhanced", pos = {x=6,y=5}, effect = "Flame Card", label = "Flame Card", config = {mult_add = 1, mult=0}},  --Works
        m_brutal =  {max = 500, order = 14, name = "Brutal Card", set = "Enhanced", pos = {x=0,y=6}, effect = "Brutal Card", label = "Brutal Card", config = {Xmult = 4}}, -- works
        m_catalyst= {max = 500, order = 15, name = "Catalyst Card", set = "Enhanced", pos = {x=1,y=6}, effect = "Catalyst Card", label = "Catalyst Card", config = {}},  --Works
        m_blank =   {max = 500, order = 16, name = "Blank Card", set = "Enhanced", pos = {x=0,y=5}, effect = "Blank Card", label = "Blank Card", config = {Xmult = 3, blank_front = true}}, -- works
        m_mirror =  {max = 500, order = 17, name = "Mirror Card", set = "Enhanced", pos = {x=5,y=5}, effect = "Mirror Card", label = "Mirror Card", config = {blank_front = true}}, -- works

        m_weakened= {max = 500, order = 12, name = "Muscle Card", set = "Enhanced", pos = {x=3,y=5}, effect = "Weakened Muscle Card", label = "Weakened Muscle Card", config = {}}, -- works
        ...
        blank_mirror={pos={x=6,y=1},config={blank_mirror=true}},
    }
