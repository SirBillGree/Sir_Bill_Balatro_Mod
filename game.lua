...
-- Mod Jokers
        ...
        c_emperor=          {order = 5,     discovered = false, cost = 3, consumeable = true, name = "The Emperor", pos = {x=4,y=0}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, invert = 'c_peasant', config = {tarots = 2}},
        ...
        c_strength=         {order = 12,    discovered = false, cost = 3, consumeable = true, name = "Strength", pos = {x=1,y=1}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, invert = 'c_weakness', config = {mod_conv = 'up_rank', max_highlighted = 2}},
        ...
        c_scientist=        {order = 24,    discovered = false, cost = 3, consumeable = true, name = "A Scientist", pos = {x=1,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_magician', config = {mod_conv = 'm_catalyst', max_highlighted = 2}},
        ...
        c_vanity=           {order = 26,    discovered = false, cost = 3, consumeable = true, name = "Vanity", pos = {x=3,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_empress', config = {mod_conv = 'm_mirror', max_highlighted = 1}},
        ...
        c_non_believer=     {order = 28,    discovered = false, cost = 3, consumeable = true, name = "A Non-Believer", pos = {x=5,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_heirophant', config = {mod_conv = 'm_blank', max_highlighted = 2}},
        c_cheater=          {order = 29,    discovered = false, cost = 3, consumeable = true, name = "A Cheater", pos = {x=6,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_lovers', config = {mod_conv = 'm_marked', max_highlighted = 1}},
        c_athlete=          {order = 30,    discovered = false, cost = 3, consumeable = true, name = "An Athlete", pos = {x=7,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_chariot', config = {mod_conv = 'm_resil', max_highlighted = 1}},
        c_tyrant=           {order = 31,    discovered = false, cost = 3, consumeable = true, name = "A Tyrant", pos = {x=8,y=0}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_justice', config = {mod_conv = 'm_brutal', max_highlighted = 1}},
        c_tennent=          {order = 32,    discovered = false, cost = 3, consumeable = true, name = "A Tennent", pos = {x=9,y=0}, set = "Tarot", effect = "Set money", cost_mult = 1.0, invert = 'c_hermit', config = {extra = 20}},
        ...
        c_weakness=         {order = 34,    discovered = false, cost = 3, consumeable = true, name = "Weakness", pos = {x=1,y=1}, set = "Tarot", effect = "Rank Change", cost_mult = 1.0, invert = 'c_strength', config = {mod_conv = 'down_rank', max_highlighted = 2}},
        ...
        c_impulse=          {order = 37,    discovered = false, cost = 3, consumeable = true, name = "Impulse", pos = {x=4,y=1}, set = "Tarot", effect = "Hand Payout", cost_mult = 1.0, invert = 'c_temperance', config = {extra = 100}},
        c_angel=            {order = 38,    discovered = false, cost = 3, consumeable = true, name = "An Angel", pos = {x=5,y=1}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_devil', config = {mod_conv = 'm_flame', max_highlighted = 1}},
        c_mountain=         {order = 39,    discovered = false, cost = 3, consumeable = true, name = "A Mountain", pos = {x=6,y=1}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_tower', config = {mod_conv = 'm_crystal', max_highlighted = 1}},
        c_dust=             {order = 40,    discovered = false, cost = 3, consumeable = true, name = "Dust", pos = {x=7,y=1}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, invert = 'c_star', config = {suit_conv = 'Diamonds', max_highlighted = 5}},
        c_night=            {order = 41,    discovered = false, cost = 3, consumeable = true, name = "Night", pos = {x=8,y=1}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, invert = 'c_moon', config = {suit_conv = 'Clubs', max_highlighted = 5}},
        c_day=              {order = 42,    discovered = false, cost = 3, consumeable = true, name = "Day", pos = {x=9,y=1}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, invert = 'c_sun', config = {suit_conv = 'Hearts', max_highlighted = 5}},
        ...
        c_void=             {order = 44,    discovered = false, cost = 3, consumeable = true, name = "Void", pos = {x=1,y=2}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, invert = 'c_world', config = {suit_conv = 'Spades', max_highlighted = 5}},
        ...
        --modded enhancements
        m_crystal = {max = 500, order = 10, name = "Crystal Card", set = "Enhanced", pos = {x=0,y=1}, effect = "Crystal Card", label = "Crystal Card", config = {}},
        m_marked =  {max = 500, order = 11, name = "Marked Card", set = "Enhanced", pos = {x=0,y=4}, effect = "Marked Card", label = "Marked Card", config = {}},
        m_resil =   {max = 500, order = 12, name = "Resilient Card", set = "Enhanced", pos = {x=4,y=0}, effect = "Resilient Card", label = "Resilient Card", config = {}},
        m_flame =   {max = 500, order = 13, name = "Flame Card", set = "Enhanced", pos = {x=4,y=3}, effect = "Flame Card", label = "Flame Card", config = {mult_add = 2}},
        ...
        m_blank =   {max = 500, order = 16, name = "Blank Card", set = "Enhanced", pos = {x=1,y=0}, effect = "Blank Card", label = "Blank Card", config = {}},
        m_mirror =  {max = 500, order = 17, name = "Mirror Card", set = "Enhanced", pos = {x=6,y=1}, effect = "Mirror Card", label = "Mirror Card", config = {}},
