...
-- Mod Jokers
        ...
        c_critic=           {order = 25,    discovered = false, cost = 3, consumeable = true, name = "A Critic", pos = {x=2,y=0}, set = "Tarot", effect = "Pack Reroll", cost_mult = 1.0, invert = 'c_high_priestess', config = {}},                                -- Some bugs
        ...
        c_merchant=         {order = 27,    discovered = false, cost = 3, consumeable = true, name = "A Merchant", pos = {x=4,y=0}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, invert = 'c_emperor', config = {spectrals = 1}},
        ...
        c_roulette=         {order = 33,    discovered = false, cost = 3, consumeable = true, name = "A Roulette", pos = {x=0,y=1}, set = "Tarot", effect = "Roulette", cost_mult = 1.0, invert = 'c_wheel_of_fortune', config = {extra = 4}},                      --works
        c_weakness=         {order = 34,    discovered = false, cost = 3, consumeable = true, name = "Weakness", pos = {x=1,y=1}, set = "Tarot", effect = "Rank Change", cost_mult = 1.0, invert = 'c_strength', config = {mod_conv = 'shift rank', extra=-1, max_highlighted = 3}}, --works
        c_mercy=            {order = 35,    discovered = false, cost = 3, consumeable = true, name = "A Mercy", pos = {x=2,y=1}, set = "Tarot", effect = "Card Creation", cost_mult = 1.0, invert = 'c_hanged_man', config = {extra = 2}},                          --works
        c_life=             {order = 36,    discovered = false, cost = 3, consumeable = true, name = "Life", pos = {x=3,y=1}, set = "Tarot", effect = "Card Conversion", cost_mult = 1.0, invert = 'c_death', config = {mod_conv = 'card', max_highlighted = 2, min_highlighted = 2}}, --works
        ...
        c_dust=             {order = 40,    discovered = false, cost = 3, consumeable = true, name = "Dust", pos = {x=7,y=1}, set = "Tarot", effect = "Perma Bonus", cost_mult = 1.0, invert = 'c_star', config = {mod_conv = true, extra=10, max_highlighted = 3}}, --works
        c_night=            {order = 41,    discovered = false, cost = 3, consumeable = true, name = "Night", pos = {x=8,y=1}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, invert = 'c_moon', config = {suit_conv = {'Spades','Clubs'}, max_highlighted = 5}}, --works
        c_day=              {order = 42,    discovered = false, cost = 3, consumeable = true, name = "Day", pos = {x=9,y=1}, set = "Tarot", effect = "Suit Conversion", cost_mult = 1.0, invert = 'c_sun', config = {suit_conv = {'Hearts', 'Diamonds'}, max_highlighted = 5}}, --works
        ...
        c_void=             {order = 44,    discovered = false, cost = 3, consumeable = true, name = "Void", pos = {x=1,y=2}, set = "Tarot", effect = "Enhance", cost_mult = 1.0, invert = 'c_world', config = {mod_conv = true, max_highlighted = 3}}, --works
