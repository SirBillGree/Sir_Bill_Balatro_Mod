...
-- Mod Jokers
        ...
        c_mercy=            {order = 35,    discovered = false, cost = 3, consumeable = true, name = "A Mercy", pos = {x=2,y=1}, set = "Tarot", effect = "Card Creation", cost_mult = 1.0, invert = 'c_hanged_man', config = {extra = 2}},
