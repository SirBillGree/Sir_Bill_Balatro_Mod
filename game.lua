...
-- Mod Jokers
        ...
        c_strength=         {order = 12,    discovered = false, cost = 3, consumeable = true, name = "Strength", pos = {x=1,y=1}, set = "Tarot", effect = "Round Bonus", cost_mult = 1.0, invert = 'c_weakness', config = {mod_conv = 'shift rank', rank_change=1, max_highlighted = 2}},
        ...
        c_weakness=         {order = 34,    discovered = false, cost = 3, consumeable = true, name = "Weakness", pos = {x=1,y=1}, set = "Tarot", effect = "Rank Change", cost_mult = 1.0, invert = 'c_strength', config = {mod_conv = 'shift rank', rank_change=-1, max_highlighted = 3}}, --need test
